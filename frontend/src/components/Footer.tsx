  ...
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 fixed bottom-0 left-0 w-full z-50">
      <div className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 px-4">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-4 text-xs sm:text-sm md:place-self-center md:justify-self-end">
          <a href="/privacy-policy" className="link link-hover">Privacy</a>
          <a href="/terms-of-service" className="link link-hover">Terms</a>
