...
//   const imageSrc = user?.photoUrl && user.photoUrl.trim() !== "" ? user.photoUrl : null;
...
//                 className="btn btn-ghost btn-circle avatar"
//               >
//                 <div className="w-10 rounded-full bg-neutral-content flex items-center justify-center overflow-hidden">
//                   {imageSrc ? (
//                     <img alt="profile" src={imageSrc} className="w-full h-full object-cover" />
//                   ) : (
//                     <span className="text-xl font-bold uppercase text-neutral">
